...
function processText() {
    ...
    if (!plainText || key.length !== 8) {
        alert("Vui lòng nhập văn bản và khóa hợp lệ (8 ký tự).");
        return;
    }
    ...
    if (action === "encode") {
        ...
        result = desDecrypt(plainText, key);
    }
